...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(37:3) {#if favorites.length > 0}",
    		ctx
    	});
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*favorites, dadjoke, addToFaves*/ 11) {
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler_2(...args) {
    		return /*click_handler_2*/ ctx[8](/*fav*/ ctx[9], ...args);
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!current || dirty & /*favorites, dadjoke*/ 3 && div0_style_value !== (div0_style_value = /*favorites*/ ctx[1].includes(/*dadjoke*/ ctx[0])
    			? "fill: #5946E8"
    			: "fill:white")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(55:3) {#each favorites as fav}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, div, anchor);
    			mount_component(bookmarkicon, div, null);
    			current = true;
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*favorites, dadjoke*/ 3 && div_style_value !== (div_style_value = /*favorites*/ ctx[1].includes(/*dadjoke*/ ctx[0])
    			? "fill: #5946E8"
    			: "fill:white")) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler_1 = () => addToFaves(dadjoke);
    	const click_handler_2 = fav => addToFaves(fav);
